...
from django_localflavor_pl.pl_administrativeunits import ADMINISTRATIVE_UNIT_CHOICES
from django_localflavor_pl.pl_voivodeships import VOIVODESHIP_CHOICES
